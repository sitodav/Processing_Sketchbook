void setup()
{
  size(800,800,OPENGL);
  background(0); 
  lvl = new Livello(new PVector[]{ new PVector(0,0,-500), new PVector(width,0,-500), new PVector(width,height,-500), new PVector(0,height,-500) },new Palla(new PVector(0,0,150),30));
